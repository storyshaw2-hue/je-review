...
<script>
  ...
  (function () {{
    ...
    var obs = new MutationObserver(function () {{
      // Wait for a REAL interactive element, not just the skeleton.
      // stFileUploader appears only after Pyodide + Streamlit + our app code all loaded.
      var mounted = document.querySelector('[data-testid="stFileUploader"]') ||
                    document.querySelector('[data-testid="stSidebar"] [data-testid="stHeader"]') ||
